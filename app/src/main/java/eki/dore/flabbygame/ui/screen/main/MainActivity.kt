package eki.dore.flabbygame.ui.screen.main
...
import eki.dore.flabbygame.customview.GameSurfaceView
import eki.dore.flabbygame.databinding.ActivityMainBinding
...
import eki.dore.flabbygame.sound.SoundManager
import eki.dore.flabbygame.ui.screen.start.StartActivity.Companion.KEY_COLOR_SET
import eki.dore.flabbygame.ui.screen.start.StartViewModel.Companion.MUSIC_KEY
import eki.dore.flabbygame.ui.screen.start.StartViewModel.Companion.SOUND_KEY
import eki.dore.flabbygame.ui.pause_screen.PauseFragment
import eki.dore.flabbygame.ui.screen.game_over.GameOverFragment
import eki.dore.flabbygame.util.Constant.BEST_SCORE
import eki.dore.flabbygame.util.GameValue
import eki.dore.flabbygame.util.LogUtils
...
class MainActivity : AppCompatActivity(), SurfaceHolder.Callback {
    ...
    private fun setDieEvent() {
        if (!isUnDeath) {
            ...
            gameOverFragment.arguments = bundleOf(eki.dore.flabbygame.ui.screen.main.MainActivity.Companion.KEY_SCORE to userPoint)
