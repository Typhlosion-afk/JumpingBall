package eki.dore.flabbygame.ui.screen.start
...
import eki.dore.flabbygame.databinding.ActivityStartBinding
import eki.dore.flabbygame.game_obj.ColorSet
import eki.dore.flabbygame.ui.core.BaseActivity
...
class StartActivity : BaseActivity<ActivityStartBinding>(ActivityStartBinding::inflate) {
    ...
    private fun initViewAction(){
        ...
        binding.txtPlay.setOnClickListener {
            val intent = Intent(this, eki.dore.flabbygame.ui.screen.main.MainActivity::class.java)
